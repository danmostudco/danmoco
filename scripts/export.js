// example taken from leerob.io
// https://github.com/leerob/leerob.io/blob/master/scripts/export.js
const fs = require("fs");
        ...
        <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
            ${pages
              .map(page => {
                ...
                return `
                    <url>
                        <loc>${`https://danmo.co${removeTrailingSlash(
                          loc
                        )}`}</loc>
                    </url>
                `;
...
const tasks = new Listr([
  ...
  },
  {
    task: () =>
      del([
        `${exportDirectory}/**/*.pxd/`,
        `${exportDirectory}/index`,
        `${exportDirectory}/static/root`
      ]),
